...
class BaseLognormalSABR(BaseSABR):
    ...
    def normal_vol(self, k):
        ...
        v_n = sabr.shifted_lognormal_to_normal(k, f, s, t, v_sln)
        return v_n
    ...
    def call(self, k, cp="call"):
        ...
        f, s, t = self.f, self.shift, self.t
        v_sln = self.lognormal_vol(k)
        pv = sabr.shifted_lognormal_call(k, f, s, t, v_sln, 0., cp)
        return pv
...
class BaseNormalSABR(BaseSABR):
    ...
    def lognormal_vol(self, k):
        ...
        v_sln = sabr.normal_to_shifted_lognormal(k, f, s, t, v_n)
        return v_sln
    ...
    def call(self, k, cp='call'):
        ...
        pv = sabr.normal_call(k, f, t, v_n, 0., cp)
        return pv
